    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-10">
                        <div class="form-group row">
                            <label for="inputEmail3" class="col col-form-labe">Овог</label>
                            <div class="col-11">
                                <input type="email" 
                                    class="form-control" 
                        ...
                        <div class="form-group row">
                            <label for="inputEmail3" class="col col-form-label">Нэр</label>
                            <div class="col-11">
                                <input type="email" 
                                    class="form-control" 
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-2 col-form-label text-right">И-мэйл хаяг</label>
                    <div class="col-10">
                        <input type="email" 
                            class="form-control" 
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-2 col-form-label text-right">Нууц үг</label>
                    <div class="col-10">
                        <input type="password" 
                            class="form-control" 
                ...
                <div class="form-group row">
                    <label for="inputEmail3" class="col-2 col-form-label text-right">Утасны дугаар</label>
                    <div class="col-10">
                        <input type="email" 
                            class="form-control" 
